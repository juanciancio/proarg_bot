...
export const birthdateStep_Repeat =
  'Por favor, ingresa tu fecha de nacimiento con el formato DD/MM/YYYY. (Ej: 25/04/2000).';

export const telegramAliasStep =
...
export const telegramAliasStep_Repeat = 'Por favor, introduce tu Alias de Telegram ( sin el @ )';
